...
base_name = "7.0.1_base" ; offset = TRUE
base_name = "7.0.1_base_no_bio_offsets"; offset = FALSE
#base_name = "7.0.1_base_no_bio_offsets_est_m"
base_name = "7.0.1_base_2011_survey_select_no_offset"; offset = FALSE
base_name = "7.0.1_base_2011_survey_select"; offset = TRUE
para = "M"
param = c("MGparm[1]", "MGparm[13]")
#offset = FALSE

# Profile range for female M
M_f <- seq(0.06, 0.12, 0.005)
M_m <- seq(0.06, 0.12, 0.005)
...
#ggsave(file.path(getwd(), "joint_m_profile_ggsave.png"), width = 12, height = 12)
dev.off()
