...
setwd("N:/Assessments/CurrentAssessments/Dover_sole_2021/data/survey/wcgbts")
...
write.csv(strata, file = file.path(getwd(), "nwfcs_wgbts_2011_strata.csv"))
...
Ages <- SurveyAFs.fn(dir = getwd(), datA = age, datTows = catch,  
                     ...
                     sex = 3, nSamps = n, month = 7, fleet = 7, ageErr = NA, agelow = -1, agehigh = -1)
...
setwd("N:/Assessments/CurrentAssessments/Dover_sole_2021/data/survvey/triennial")
...
# There is no ages in the triennial data
...
n = GetN.fn(dir=getwd(), dat = len, type = "length", species = "flatfish", printfolder = "forSS")
file.rename(file.path(getwd(), "forSS", "length_SampleSize.csv"), 
            file.path(getwd(), "forSS", "triennial_length_samps.csv") )
...
setwd("N:/Assessments/CurrentAssessments/Dover_sole_2021/data/survey/nwfsc_slope")
...
slope_strata = CreateStrataDF.fn(names=c("shallow_north", "shallow_central", "shallow_south", "mid_north", "mid_central", "mid_south", 
...
setwd("N:/Assessments/CurrentAssessments/Dover_sole_2021/data/survvey/")
...
slope_strata = CreateStrataDF.fn(names=c("shallow_north", "shallow_central", "shallow_south", 
                                          "mid_north", "mid_central", "mid_south", 
                                          "deep_north", "deep_central", "deep_south"), 
                           depths.shallow = c(183,  183,  183,  549,  549,  549,   900,   900,  900),
                           depths.deep    = c(549,  549,  549,  900,  900,  900,  1280,  1280, 1280),
                           lats.south     = c(45.0, 40.5, 34.5, 45.0, 40.5, 34.5, 45.0,  40.5, 34.5),
                           lats.north     = c(49.0, 45.0, 40.5, 49.0, 45.0, 40.5, 49.0,  45.0, 40.5))