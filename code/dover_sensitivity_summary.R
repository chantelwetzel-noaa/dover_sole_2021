...
model.list <- c(paste0(base_model, "_no_recdevs"), #1
                ...
                paste0(base_model, "_rec_block"),
                paste0(base_model, "_index_cpfv"), # 11
                paste0(base_model, "_index_recfin")) #12
...
modelnames2 <- c("Base Model",
                ...
                "2013 RecFIN Dockside Index")

x1 <- SSsummarize(list(base, sens_1, sens_2, sens_3, sens_4, sens_5, sens_6))
x2 <- SSsummarize(list(base, sens_7, sens_8, sens_9, sens_10, sens_11, sens_12))
...
x <- SSsummarize(list(base, sens_1, sens_2, sens_3, sens_4, sens_5, sens_6, 
          sens_7, sens_8, sens_9, sens_10, sens_11, sens_12))
...
file = file.path("C:/Assessments/2021/copper_rockfish_2021/write_up/tex_tables/sensitivities.tex"))