...
```{r, results = 'asis'}
add_figure(
filein = file.path(mod_loc, "plots", "comp_lendat_bubflt1mkt2_page3.png"), 
...
```{r, results = 'asis'}
brid_loc = "C:/Assessments/2021/dover_sole_2021/models/_bridging"
add_figure(
