...
\hypersetup{
  pdftitle={Dover sole (Microstomus pacificus) along the US West coast in 2020},
  pdflang={en},
  hidelinks,
...
\date{}
\newcommand{\trTitle}{Dover sole (\emph{Microstomus pacificus}) along the US West coast in 2020}
...
\noindent
\begin{center}
\title{Dover sole (\emph{Microstomus pacificus}) along the US West coast in 2020}
% \textnormal{\MakeTextUppercase{\trTitle{}}}
\vspace{1.5cm}
{\Large\textbf\newline{Dover sole (\emph{Microstomus pacificus}) along the US West coast in 2020}}
\vfill
by\\
...
This assessment reports the status of Dover sole (\emph{Microstomus pacificus}) off the US West coast using data through xxxx.
